...
var Search = /** @class */ (function () {
    function Search() {
        var _this = this;
        this.searchElement = document.getElementById('input');
        this.resultsContainer = document.getElementById('results');
        var sequence$ = rxjs_1.fromEvent(this.searchElement, 'input');
        Search.getSearchObservable(sequence$)
            ...
            if (result.items && Array.isArray(result.items)) {
                _this.resultsContainer.innerHTML = result.items
    ...
    Search.getSearchObservable = function (source$) {
        return source$.pipe(operators_1.debounceTime(300), operators_1.distinctUntilChanged(), 
        // pluck(),
        // tap(),
        operators_1.map(function (event) { return event.target.value; }), operators_1.switchMap(function (searchString) {
            return (fetch("https://api.github.com/search/repositories?q=" + searchString)
                .then(function (res) { return res.json(); }));
        }));
    };
    Search.renderCard = function (item) {
